...
const char DevBase::utf16toAscii[maxUtf16toAscii + 1] =
{
  ...
  'A',  // 00C1 Á Latin Capital letter A with acute
  'A',  // 00C2 Â Latin Capital letter A with circumflex
  'A',  // 00C3 A Latin Capital letter A with tilde
  'A',  // 00C4 Ä Latin Capital letter A with diaeresis
  'A',  // 00C5 A Latin Capital letter A with ring above
  'A',  // 00C6 A Latin Capital letter AE
  'C',  // 00C7 Ç Latin Capital letter C with cedilla
  'E',  // 00C8 E Latin Capital letter E with grave
  'E',  // 00C9 É Latin Capital letter E with acute
  'E',  // 00CA E Latin Capital letter E with circumflex
  'E',  // 00CB Ë Latin Capital letter E with diaeresis
  'I',  // 00CC I Latin Capital letter I with grave
  'I',  // 00CD Í Latin Capital letter I with acute
  'I',  // 00CE Î Latin Capital letter I with circumflex
  ...
  'O',  // 00D3 Ó Latin Capital letter O with acute
  'O',  // 00D4 Ô Latin Capital letter O with circumflex
  'O',  // 00D5 O Latin Capital letter O with tilde
  'O',  // 00D6 Ö Latin Capital letter O with diaeresis
  ...
  'Y',  // 00DD Ý Latin Capital Letter Y with acute
  '?',  // 00DE ? Latin Capital Letter Thorn
  's',  // 00DF ß Latin Small Letter sharp S
  'a',  // 00E0 a Latin Small Letter A with grave
  'a',  // 00E1 á Latin Small Letter A with acute
  'a',  // 00E2 â Latin Small Letter A with circumflex
  'a',  // 00E3 a Latin Small Letter A with tilde
  'a',  // 00E4 ä Latin Small Letter A with diaeresis
  'a',  // 00E5 a Latin Small Letter A with ring above
  'a',  // 00E6 a Latin Small Letter AE
  'c',  // 00E7 ç Latin Small Letter C with cedilla
  'e',  // 00E8 e Latin Small Letter E with grave
  'e',  // 00E9 é Latin Small Letter E with acute
  'e',  // 00EA e Latin Small Letter E with circumflex
  'e',  // 00EB ë Latin Small Letter E with diaeresis
  'i',  // 00EC i Latin Small Letter I with grave
  'i',  // 00ED í Latin Small Letter I with acute
  'i',  // 00EE î Latin Small Letter I with circumflex
  ...
  'o',  // 00F3 ó Latin Small Letter O with acute
  'o',  // 00F4 ô Latin Small Letter O with circumflex
  'o',  // 00F5 o Latin Small Letter O with tilde
  'o',  // 00F6 ö Latin Small Letter O with diaeresis
  '-',  // 00F7 ÷ Division sign
  ...
  'y',  // 00FD ý Latin Small Letter Y with acute
  ...
  'A',  // 0102 Ã Latin Capital Letter A with breve
  'a',  // 0103 ã Latin Small Letter A with breve
  'A',  // 0104 ¥ Latin Capital Letter A with ogonek
  'a',  // 0105 ¹ Latin Small Letter A with ogonek
  'C',  // 0106 Æ Latin Capital Letter C with acute
  'c',  // 0107 æ Latin Small Letter C with acute
  ...
  'C',  // 010C È Latin Capital Letter C with caron
  'c',  // 010D è Latin Small Letter C with caron
  'D',  // 010E Ï Latin Capital Letter D with caron
  'd',  // 010F ï Latin Small Letter D with caron
  'D',  // 0110 Ð Latin Capital Letter D with stroke
  'd',  // 0111 ð Latin Small Letter D with stroke
  ...
  'E',  // 0118 Ê Latin Capital Letter E with ogonek
  'e',  // 0119 ê Latin Small Letter E with ogonek
  'E',  // 011A Ì Latin Capital Letter E with caron
  'e',  // 011B ì Latin Small Letter E with caron
  ...
  'L',  // 0139 Å Latin Capital Letter L with acute
  'l',  // 013A å Latin Small Letter L with acute
  ...
  'N',  // 0143 Ñ Latin Capital Letter N with acute
  'n',  // 0144 ñ Latin Small Letter N with acute
  'N',  // 0145 N Latin Capital Letter N with cedilla
  'n',  // 0146 n Latin Small Letter N with cedilla
  'N',  // 0147 Ò Latin Capital Letter N with caron
  'n',  // 0148 ò Latin Small Letter N with caron
  ...
  'O',  // 0150 Õ Latin Capital Letter O with double acute
  'o',  // 0151 õ Latin Small Letter O with double acute
  'O',  // 0152 O Latin Capital Ligature OE
  'o',  // 0153 o Latin Small Ligature OE
  'R',  // 0154 À Latin Capital Letter R with acute
  'r',  // 0155 à Latin Small Letter R with acute
  'R',  // 0156 R Latin Capital Letter R with cedilla
  'r',  // 0157 r Latin Small Letter R with cedilla
  'R',  // 0158 Ø Latin Capital Letter R with caron
  'r',  // 0159 ø Latin Small Letter R with caron
  'S',  // 015A Œ Latin Capital Letter S with acute
  's',  // 015B œ Latin Small Letter S with acute
  'S',  // 015C S Latin Capital Letter S with circumflex
  's',  // 015D s Latin Small Letter S with circumflex
  'S',  // 015E ª Latin Capital Letter S with cedilla
  's',  // 015F º Latin Small Letter S with cedilla
  'S',  // 0160 Š Latin Capital Letter S with caron
  's',  // 0161 š Latin Small Letter S with caron
  'T',  // 0162 Þ Latin Capital Letter T with cedilla
  't',  // 0163 þ Latin Small Letter T with cedilla
  ...
  'U',  // 016E Ù Latin Capital Letter U with ring above
  'u',  // 016F ù Latin Small Letter U with ring above
  'U',  // 0170 Û Latin Capital Letter U with double acute
  'u',  // 0171 û Latin Small Letter U with double acute
  ...
  'z',  // 017A Ÿ Latin Small Letter Z with acute
  'Z',  // 017B ¯ Latin Capital Letter Z with dot above
  'z',  // 017C ¿ Latin Small Letter Z with dot above
  'Z',  // 017D Ž Latin Capital Letter Z with caron
  'z',  // 017E ž Latin Small Letter Z with caron
  ...
  'D',  // 0189 Ð Latin Capital Letter African D
