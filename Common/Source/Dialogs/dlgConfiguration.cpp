...
static CallBackTableEntry_t CallBackTable[]={
  CallbackEntry(OnAirspaceColoursClicked),
  CallbackEntry(OnAirspaceFilesClicked),
  CallbackEntry(OnWaypointFilesClicked),
  CallbackEntry(OnAirspaceModeClicked),
  CallbackEntry(OnAirspaceWarningParamsClicked),
  CallbackEntry(OnUTCData),
  CallbackEntry(OnNextClicked),
  CallbackEntry(OnPrevClicked),
  CallbackEntry(OnInfoBoxHelp),
  CallbackEntry(OnWaypointNewClicked),
  CallbackEntry(OnWaypointDeleteClicked),
  CallbackEntry(OnWaypointEditClicked),
  CallbackEntry(OnWaypointSaveClicked),
  CallbackEntry(OnLKMapOpenClicked),

  CallbackEntry(OnDeviceAData),  
  CallbackEntry(OnComPort1Data),

  CallbackEntry(OnSetTopologyClicked),
  CallbackEntry(OnSetCustomKeysClicked),
  CallbackEntry(OnMultimapsClicked),
  CallbackEntry(OnSetCustomMenuClicked),
  CallbackEntry(OnSetBottomBarClicked),
  CallbackEntry(OnSetInfoPagesClicked),
  CallbackEntry(OnTaskRulesClicked),
  CallbackEntry(OnSetOverlaysClicked),
  
  CallbackEntry(OnAirspaceFillType),
  ...
  CallbackEntry(OnE),
  CallbackEntry(OnF),
  CallbackEntry(OnConfigDevClicked),
  CallbackEntry(OnConfigDevReplayClicked),
  CallbackEntry(OnNextDevice),
  ...
  CallbackEntry(OnCompetitionIDClicked),
