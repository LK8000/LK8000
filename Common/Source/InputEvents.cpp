...
void InputEvents::eventMinimapKey(const TCHAR *misc) {
    ...
    if (_tcscmp(misc, TEXT("J")) == 0) {
        ...
        if (isSelectMode()) {
            ...
            do {
                switch (SelectedButtonIndex) {
                    case 1:
                    case 2:
                    case 3: SelectedButtonIndex++;
                        break;
                    case 4: SelectedButtonIndex = 9;
                        break;
                    case 5: SelectedButtonIndex = 10;
                        break;
                    case 6:
                    case 7:
                    case 8:
                    case 9: SelectedButtonIndex--;
                        break;
                    case 10:
                    case 11:
                    case 12: SelectedButtonIndex++;
                        break;
                    case 13: SelectedButtonIndex = 1;
                        break;
                    default:
                        SelectedButtonIndex = 1;
                        break;
        ...
        if (isSelectMode()) {
            ...
            do {
                switch (SelectedButtonIndex) {
                    case 1: SelectedButtonIndex = 13;
                        break;
                    case 2:
                    case 3:
                    case 4: SelectedButtonIndex--;
                        break;
                    case 5:
                    case 6:
                    case 7:
                    case 8: SelectedButtonIndex++;
                        break;
                    case 9: SelectedButtonIndex = 4;
                        break;
                    case 10: SelectedButtonIndex = 5;
                        break;
                    case 11:
                    case 12:
                    case 13: SelectedButtonIndex--;
                        break;
                    default:
                        SelectedButtonIndex = 1;
                        break;
