...
#ifndef THREAD_STDCPP_THREAD_HPP
#define THREAD_STDCPP_THREAD_HPP
...
class Thread {
 public:
  ...
  virtual ~Thread() {
    ...
    assert(!_running.load(std::memory_order_acquire) && !_thread.joinable());
  }
...
#endif  // THREAD_STDCPP_THREAD_HPP
