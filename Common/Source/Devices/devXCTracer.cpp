...
bool LXWP0(DeviceDescriptor_t* d, char **params, size_t nparams, NMEA_INFO *pGPS)
{
    ...
    {
        TrueAirSpeed = Units::ToSys(unKiloMeterPerHour, TrueAirSpeed);
            ...
            ReadChecked(params[12], pGPS->ExternalWindSpeed))
    {
        ...
        pGPS->ExternalWindSpeed = Units::ToSys(unKiloMeterPerHour, pGPS->ExternalWindSpeed);  /* convert to system unit */
