...
/* return true for all supported platforms (ANDROID, WIN32) and for debug
 * builds to allow testing the GUI on unsupported platforms */
#if defined(ANDROID) || defined(WIN32) || !defined(NDEBUG)
  return true;
#endif
  return false;
}
