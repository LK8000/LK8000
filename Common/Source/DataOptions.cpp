...
void FillDataOptions() {
	...
	// LKTOKEN  _@M2480_ = "Home Req.Efficiency", _@M2481_ = "Home.E"
	SetDataOption(LK_HOME_GR, ugNone, TEXT("_@M2480_"), TEXT("_@M2481_"));
	...
	SetDataOption(LK_HOME_BRG, ugNone, TEXT("_@M2484_"), TEXT("_@M2485_")); // Home bearing
	...
	SetDataOption(LK_HOME_ALT_UNIT, ugDistance, TEXT("_@M2482_"), TEXT("_@M2483_")); //  home distance alternate unit
