...
class MapWindow {
 ...
 public:
  ...
  static airspace_config AirspaceMode() {
    const std::lock_guard lock(AirspaceMutex);
 ...
 public:
  ...
  // list of airspace colors
  // DO NOT CHANGE THE ORDER OF COLORS, AS THEY ARE USED IN SETTINGS
  constexpr static auto Colours = std::to_array<RGB8Color>({
      {0xFF, 0x00, 0x00},  // Red
...
private:
 ...
 public:
  ...
  static void SetTargetPanWaypoint(int wp_index, unsigned dlgSize = 0);
