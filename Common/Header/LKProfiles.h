...
TCHAR szRegistryAutoOrientScale[]= TEXT("AutoOrientScale1");
...
TCHAR szRegistryLKTopoZoomCat10[]= TEXT("LKTopoZoomCat10a");
...
TCHAR szRegistryMultiOvr0[] = _T("MultimapOvr0");
TCHAR szRegistryMultiOvr1[] = _T("MultimapOvr1");
TCHAR szRegistryMultiOvr2[] = _T("MultimapOvr2");
TCHAR szRegistryMultiOvr3[] = _T("MultimapOvr3");
...
extern TCHAR szRegistryMultiOvr0[];
extern TCHAR szRegistryMultiOvr1[];
extern TCHAR szRegistryMultiOvr2[];
extern TCHAR szRegistryMultiOvr3[];
