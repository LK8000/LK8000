...
BIN_DATA(IDR_XML_SELECTITEM_L)
BIN_DATA(IDR_XML_SELECTITEM_P)
...
BIN_DATA(IDR_XML_SELECTOBJECT_P)
BIN_DATA(IDR_XML_SELECTOBJECT_L)
...
BIN_DATA(IDR_XML_APPROACH_P)
BIN_DATA(IDR_XML_APPROACH_L)
BIN_DATA(IDR_XML_APPROACH_APPROVE_P)
BIN_DATA(IDR_XML_APPROACH_APPROVE_L)

BIN_DATA(IDR_XML_TRACKING)

BIN_DATA(IDR_XML_DIRECTTO_COUNTDOWN_L)
BIN_DATA(IDR_XML_DIRECTTO_COUNTDOWN_P)
...
static const named_ressource_t named_resources[] = {
    ...
    NAMED_RESOURCE(IDR_XML_SELECTITEM_P),
    NAMED_RESOURCE(IDR_XML_SELECTITEM_L),
    ...
    NAMED_RESOURCE(IDR_XML_SELECTOBJECT_P),
    NAMED_RESOURCE(IDR_XML_SELECTOBJECT_L),
    ...
    NAMED_RESOURCE(IDR_XML_APPROACH_P),
    NAMED_RESOURCE(IDR_XML_APPROACH_L),
    NAMED_RESOURCE(IDR_XML_APPROACH_APPROVE_P),
    NAMED_RESOURCE(IDR_XML_APPROACH_APPROVE_L),
    NAMED_RESOURCE(IDR_XML_DIRECTTO_COUNTDOWN_L),
    NAMED_RESOURCE(IDR_XML_DIRECTTO_COUNTDOWN_P),
#if !defined(WIN32) && !defined(ANDROID)
    // on win32 platform, Bitmap can't be in unix style resource.
