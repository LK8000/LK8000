...
static const struct {
    ...
    NAMED_RESSOURCE(IDR_XML_AIRSPACE_P),
    NAMED_RESSOURCE(IDR_XML_AIRSPACECOLOURS_P),
    NAMED_RESSOURCE(IDR_XML_MULTISELECTLIST_P),
    NAMED_RESSOURCE(IDR_XML_MULTISELECTLIST_L),
#ifdef HAVE_HATCHED_BRUSH
    NAMED_RESSOURCE(IDR_XML_AIRSPACEPATTERNS_P),
    NAMED_RESSOURCE(IDR_XML_AIRSPACEPATTERNS_L),
#endif
    NAMED_RESSOURCE(IDR_XML_ANALYSIS_P),
    NAMED_RESSOURCE(IDR_XML_BASICSETTINGS_P),
    NAMED_RESSOURCE(IDR_XML_BASICSETTINGS_L),
    NAMED_RESSOURCE(IDR_XML_CHECKLIST_P),
    NAMED_RESSOURCE(IDR_XML_LOGGERREPLAY),
    NAMED_RESSOURCE(IDR_XML_STARTUP_P),
    NAMED_RESSOURCE(IDR_XML_DUALPROFILE_P),
    NAMED_RESSOURCE(IDR_XML_ORACLE_P),
    ...
    NAMED_RESSOURCE(IDR_XML_TASKOVERVIEW_P),
    NAMED_RESSOURCE(IDR_XML_TASKWAYPOINT_P),
    NAMED_RESSOURCE(IDR_XML_WAYPOINTDETAILS_P),
    NAMED_RESSOURCE(IDR_XML_WAYPOINTSELECT_P),
    NAMED_RESSOURCE(IDR_XML_WAYPOINTQUICK_L),
    ...
    NAMED_RESSOURCE(IDR_XML_LKAIRSPACEWARNING_P),
    NAMED_RESSOURCE(IDR_XML_LKAIRSPACEWARNING_L),
    NAMED_RESSOURCE(IDR_XML_HELP_P),
    NAMED_RESSOURCE(IDR_XML_TEXTENTRY_KEYBOARD_P),
    NAMED_RESSOURCE(IDR_XML_TEXTENTRY_KEYBOARD_L),
    NAMED_RESSOURCE(IDR_XML_TEAMCODE),
    NAMED_RESSOURCE(IDR_XML_STARTPOINT_P),
    NAMED_RESSOURCE(IDR_XML_WAYPOINTEDIT_P),
    NAMED_RESSOURCE(IDR_XML_TARGET_P),
    ...
    NAMED_RESSOURCE(IDR_XML_COMBOPICKER_P),
    ...
    NAMED_RESSOURCE(IDR_XML_NUMENTRY_KEYBOARD_P),
    NAMED_RESSOURCE(IDR_XML_WAYPOINTEDITUTM_P),
    NAMED_RESSOURCE(IDR_XML_WAYPOINTEDITUTM_L),
    NAMED_RESSOURCE(IDR_XML_CUSTOMMENU),
    NAMED_RESSOURCE(IDR_XML_OVERLAYS),
    NAMED_RESSOURCE(IDR_XML_MULTIMAPS),
    NAMED_RESSOURCE(IDR_XML_DEVCPROBE),
    NAMED_RESSOURCE(IDR_XML_BLUETOOTH_P),
    NAMED_RESSOURCE(IDR_XML_BLUETOOTH_L),
    NAMED_RESSOURCE(IDR_XML_IGCFILE_P),
    NAMED_RESSOURCE(IDR_XML_IGCFILE_L),
    NAMED_RESSOURCE(IDR_XML_BLUEFLYCONFIG_L),
    NAMED_RESSOURCE(IDR_XML_BLUEFLYCONFIG_P),
    NAMED_RESSOURCE(IDR_XML_TERMINAL_P),
    NAMED_RESSOURCE(IDR_XML_TERMINAL_L),
    NAMED_RESSOURCE(IDR_XML_PROGRESS_P),
    NAMED_RESSOURCE(IDR_XML_PROGRESS_L),
    NAMED_RESSOURCE(IDR_XML_RADIOSETTINGS),
